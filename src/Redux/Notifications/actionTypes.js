...
export const FETCH_NOTIFICATIONS_BY_USER_SUCCESS = "FETCH_NOTIFICATIONS_BY_USER_SUCCES";
export const FETCH_NOTIFICATIONS_BY_USER_FAILURE = "FETCH_NOTIFICATIONS_BY_USER_FAILURE";

export const FETCH_NOTIFICATIONS_BY_SALON_REQUEST = "FETCH_NOTIFICATIONS_BY_SALON_REQUEST";export const FETCH_NOTIFICATIONS_BY_SALON_SUCCESS = "FETCH_NOTIFICATIONS_BY_SALON_SUCCESS";
