...
const chartReducer = (state = initialState, action) => {
    switch (action.type) {
        case FETCH_EARNINGS_REQUEST:
            return {
                ...state, earnings: { loading: true, data: null, error: null },
            };
        case FETCH_EARNINGS_SUCCESS:
            return {
                ...state, earnings: { loading: false, data: action.payload, error: null },
            };
        ...
        case FETCH_BOOKINGS_REQUEST:
            return {
                ...state, bookings: { loading: true, data: null, error: null },
            };
